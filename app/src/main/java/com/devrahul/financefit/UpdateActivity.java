...
import com.devrahul.financefit.databinding.ActivityUpdateBinding;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int maxLength = 10;
        int maxLenghtn = 6;
        binding.userAmountUpdate.setFilters(new InputFilter[]{new InputFilter.LengthFilter(maxLenghtn)});
